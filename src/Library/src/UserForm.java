...
public class UserForm extends JFrame {
	...
	public UserForm() {
		...
		JLabel lblAddress = new JLabel("Roll No./Employee Id:");
		
		JLabel lblCity = new JLabel("Hall/Residence:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			String id_no=textField_2.getText();
			String residence=textField_3.getText();
